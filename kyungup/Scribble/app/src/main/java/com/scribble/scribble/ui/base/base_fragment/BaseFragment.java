...
//import com.scribble.scribble.ui.fragment_factory.Factory;
//import com.scribble.scribble.ui.fragment.processing_dialog.ProcessingDialogFragment;
import com.scribble.scribble.ui.activity.main_activity.MainActivity;
//import com.scribble.scribble.utils.FontButton;
//import com.scribble.scribble.utils.FontTextView;
//import com.scribble.scribble.utils.ThemeUtils;
...
//    @Nullable
//    @BindView(com.scribble.scribble.R.id.toolbar)
//    Toolbar mToolbar;
...
//            dismissAlertDialog();
//            View view = LayoutInflater.from(getContext()).inflate(ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? com.scribble.scribble.R.layout.dialog_popup_fragment : com.scribble.scribble.R.layout.dialog_popup_fragment_light, null);
//
//            FontTextView tvTitle = ((FontTextView) view.findViewById(com.scribble.scribble.R.id.tv_pop_up_title));
//            tvTitle.setText(title);
//            FontTextView tvMessage = ((FontTextView) view.findViewById(com.scribble.scribble.R.id.tv_pop_up_message));
//            tvMessage.setText(message);
//            FontButton popUpButton = ((FontButton) view.findViewById(com.scribble.scribble.R.id.bt_pop_up));
//            view.findViewById(com.scribble.scribble.R.id.bt_pop_up2).setVisibility(View.GONE);
//
//            ImageView icon = ((ImageView) view.findViewById(com.scribble.scribble.R.id.iv_icon));
...
//                switch (type.name()) {
//                    case "error":
//                        icon.setImageResource(com.scribble.scribble.R.drawable.ic_error);
//                        view.findViewById(com.scribble.scribble.R.id.red_line).setVisibility(View.VISIBLE);
//                        break;
//                    case "confirm":
//                        icon.setImageResource(com.scribble.scribble.R.drawable.ic_confirm);
//                        view.findViewById(com.scribble.scribble.R.id.red_line).setVisibility(View.GONE);
//                        break;
//                }
//            } else {
//                switch (type.name()) {
//                    case "error":
//                        tvTitle.setTextColor(ContextCompat.getColor(getContext(), com.scribble.scribble.R.color.title_red_color));
//                        icon.setImageResource(com.scribble.scribble.R.drawable.ic_popup_error_light);
//                        break;
//                    case "confirm":
//                        icon.setImageResource(com.scribble.scribble.R.drawable.ic_confirmed_light);
//                        break;
//                }
//            }
//
...
//            tvMessage.setText(message);
//            FontButton popUpButton = ((FontButton) view.findViewById(com.scribble.scribble.R.id.bt_pop_up));
//            FontButton popUpButton2 = ((FontButton) view.findViewById(com.scribble.scribble.R.id.bt_pop_up2));
//            view.findViewById(com.scribble.scribble.R.id.bt_pop_up2).setVisibility(View.VISIBLE);
//
//            ImageView icon = ((ImageView) view.findViewById(com.scribble.scribble.R.id.iv_icon));
//            popUpButton.setText(buttonText);
...
//        ((MainActivity) getActivity()).showBottomNavigationView(colorRes);
    ...
    public void openRootFragment(Fragment fragment) {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(com.scribble.scribble.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
    ...
    public void openFragment(Fragment fragment) {
        ...
        getFragmentManager()
                .beginTransaction()
//                .setCustomAnimations(com.scribble.scribble.R.anim.enter_from_right, com.scribble.scribble.R.anim.exit_to_left, com.scribble.scribble.R.anim.enter_from_left, com.scribble.scribble.R.anim.exit_to_right)
                .add(com.scribble.scribble.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
                .addToBackStack(null)
                .commit();
    }
