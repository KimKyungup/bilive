...
public class ScribbleFragment extends BaseFragment implements IScribbleView {
    ...
    private ListViewScribbleAdapter mListViewPostAdapter = null;
    ...
    public void initializeViews() {
        ...
        mListViewPostAdapter = new ListViewScribbleAdapter(getContext());
    ...
    ListView.OnItemClickListener onItemClickListener = new ListView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            Toast.makeText(getContext(), "[Debug Toast] listViewPost=onItemClickListener", Toast.LENGTH_SHORT).show();
